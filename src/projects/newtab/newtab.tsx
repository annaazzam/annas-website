        ...
        <>
          ...
          <div className={styles.content}>
            <div className={styles.descriptionText}>
              A Google Chrome extension which replaces the New Tab page with a clean, simple page.
              Displays an image from a collection of beautiful curated photos, or allows you to upload your own.
            </div>
