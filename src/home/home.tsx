        ...
        <div className={styles.home}>
          <div className={styles.homeContainer}>
            ...
            <div className={styles.intro}>
              <div className={styles.annaAzzam}>ANNA AZZAM</div><br/>
              <div className={styles.introText}>
                Software Developer @ <span className={styles.fancyText}>
          ...
          <div className={styles.photogIntro}>
            <CollectionGrid
                ...
                onCardClick={(folder) => window.location.href = `/photojournals#${folder}`}
            />
            <div className={styles.seeMoreContainer}>
              <Button link="/photojournals" label="See more photo collections >"/>
            </div>
          </div>
