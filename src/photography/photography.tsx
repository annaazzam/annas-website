...
export class CollectionGrid extends React.Component<{
  ...
  render() {
    ...
    return (
        <div className={styles.photographyCards} style={{ flexWrap: wrap ? 'wrap' : 'nowrap' }}>
...
export class PhotoCollection extends React.Component<{
  ...
  private get nextPhotoAvailable() {
    ...
    return this.openLightboxIndex !== undefined && (this.openLightboxIndex < photos.length - 1);
  }
