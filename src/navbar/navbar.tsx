  ...
  render() {
    return (
        <div className={styles.navbarContainer}>
          ...
          {this.collapse ? <this.HamburgerMenu/> : <DesktopItems routes={this.routes}/>}
        </div>
    );
  }
}
...
@mobxReact.observer
class HamburgerMenuImpl extends React.Component<MenuProps & RouteChildrenProps> {
  @mobx.observable.ref
  ...
  render() {
    ...
    return (
        <>
          <div className={classNames(styles.menu, this.isMenuOpen && styles.visible)}>
          ...
          <div
              className={classNames(styles.backgroundOverlay, this.isMenuOpen && styles.visible)}
              onClick={this.closeMenu}
          />
          <img alt="menu" src={menuIcon} className={styles.menuIcon} onClick={this.openMenu}/>
        </>
    );
  }
}
...
class SocialIcons extends React.Component {
  private readonly socials: Social[] = [
    ...
    { name: 'Linkedin', icon: linkedinIcon, link: 'https://www.linkedin.com/in/annaazzam/' },
    { name: 'Instagram', icon: instagramIcon, link: 'https://www.instagram.com/annaazzam/' },
    { name: 'Stack Overflow', icon: stackOverflowIcon, link: 'https://stackoverflow.com/users/10914325/anna-azzam' },
  ];
